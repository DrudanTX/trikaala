...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "SandhyaFlow — Daily Sandhyavandhanam" },
      ...
      { property: "og:title", content: "SandhyaFlow" },
      { property: "og:description", content: "A peaceful tracker for daily Sandhyavandhanam." },
